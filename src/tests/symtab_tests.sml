...
struct
	...
	fn () => (* get_name *)
	let
		val w = B.new (B.AnonControl "W")
		val a = B.new (B.NodeControl ("A",""))
		val x = B.new (B.AnonControl "X")
		val y = B.new (B.AnonControl "Y")
		val z = B.new (B.AnonControl "Z")
	...
	fun run_all_tests () = (print "[SymtabTests]\n"; app run_test tests) handle (B.BigraphNameException b) => (print (b ^ "\n"); raise TestFailed "symtab") 
end
